...
let rootUrl = URL(string: "https://boussedraoui.github.io/mood-tracker/?app=true")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["boussedraoui.github.io"]

// auth origins will open in modal and show toolbar for back into the main origin.
// These should also appear in Info.plist
let authOrigins: [String] = ["account.google.com","login.microsoft.com","paypal.com","www.paypal.com","checkout.paypal.com"]
